...
const MachineStationFactoryContractAddress: string = '0x7330dbE35b346B14E93842Ab7Fb0AE0963f85b8E';
...
const DEPIN_SEED = "major wish sketch invite evolve ribbon stay soccer rebuild record merit popular"; // The seed phrase for DePIN Project, used for signing the DID

const PEAQ_SERVICE_URL = "https://lift-off-campaign-service-jx-devbr.jx.peaq.network"; // URL to the peaq campaign service 
// dev URL: https://lift-off-campaign-service-jx-devbr.jx.peaq.network

const API_KEY = "aa69cb8e92b2e27eb26996fc9b02f6df24"; // peaq campaign service APIKEY value added to the header of all requests
// dev APIKEY: aa69cb8e92b2e27eb26996fc9b02f6df24
// production APIKEY will be sent to you after deployment

const PROJECT_API_KEY = "all_0821fcaa69"; // peaq campaign service unique APIKEY value for specific project added to the header of all requests
